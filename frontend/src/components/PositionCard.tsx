      ...
      <CardContent>
        ...
        <Stack direction="row" spacing={1} alignItems="center" sx={{ mt: 1 }} flexWrap="wrap" useFlexGap>
          ...
          {isAiDraft && (
            <Chip
              ...
              color="info"
              variant="outlined"
              label={`AI DRAFT THESIS${pos.draft_rating_grade ? ` · ${pos.draft_rating_grade}` : ''}`}
            />
          )}
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
            ...
            <Box sx={{ mt: 1.5 }}>
              ...
              {isAiDraft && (
                <Typography variant="caption" display="block" sx={{ opacity: 0.65, mt: 0.5 }}>
                  AI-generated draft thesis — PM review/edit required. Generated by {pos.thesis_generated_by ?? 'model'}
                  {pos.thesis_generated_at ? ` on ${new Date(pos.thesis_generated_at).toLocaleString()}` : ''}.
                </Typography>
              )}
            </Box>
          )}
          ...
          >
            ...
            {pos.thesis.length > thesisPreview.length && (
              <Typography variant="caption" display="block" sx={{ opacity: 0.55, mt: 0.5 }}>
                Preview shown — open Thesis to edit/read full text.
              </Typography>
            )}
          </Box>
