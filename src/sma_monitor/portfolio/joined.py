    ...
    for p in positions:
        ...
        holdings.append(
            Holding(
                ...
                ir_url=sc.ir_url,
                press_releases_url=sc.press_releases_url,
                press_release_rss_url=sc.press_release_rss_url,
                catalysts=unresolved,
                thesis_source=sc.thesis_source,
                thesis_status=sc.thesis_status,
                ...
                draft_rating_drivers=sc.draft_rating_drivers,
